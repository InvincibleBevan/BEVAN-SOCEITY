...
module.exports = {
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY INFINITE-MD 😆*",
...
ᴋᴇᴇᴘ ᴜsɪɴɢ ✦INFINITE-MD✦ ғʀᴏᴍ BEVAN SOCEITY

*© ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ - ᴍᴅ*

> ɢɪᴛʜᴜʙ : github.com/invinciblebevan/INFINITE-MD`,
    // add alive msg here 

    STICKER_NAME: process.env.STICKER_NAME || "INFINITE-MD",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "254797827405",
    // add your bot owner number

    OWNER_NAME: process.env.OWNER_NAME || "BEVAN SOCEITY",
    // add bot owner name

    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ BEVAN SOCEITY*",
    ...
    DEV: process.env.DEV || "254797827405",
...
`*Hᴇʟʟᴏ ᴛʜᴇʀᴇ INFINITE-MD ᴄᴏɴɴᴇᴄᴛᴇᴅ! 👋🏻* 
